...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		hs+='width : 219px;';
		hs+='pointer-events:none;';
		hs+='text-shadow: 1px 1px 2px black, 0 0 1em black;';
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		el.style[domTransform]=parameterToTransform(el.ggParameter);
		hs ='position:absolute;';
	...
	player.addListener('changenode', function(args) { me._thumbnail_hide_button.logicBlock_alpha();me._thumbnail_show_button.logicBlock_alpha();me._thumbnail_menu.logicBlock_alpha(); });
